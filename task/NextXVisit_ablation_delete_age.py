...
file_config = {
    ...
    'train': './CS598_PROJECT/output_ablation_delete_age/NextXVisit_train.pkl',
    'test': './CS598_PROJECT/output_ablation_delete_age/NextXVisit_test.pkl',
}
...
global_params = {
    ...
    'device': 'cuda:0',
    'output_dir': './CS598_PROJECT/modeloutput_ablation_delete_age/', # output folder
...
pretrain_model_path = './CS598_PROJECT/modeloutput_ablation_delete_age/MLM_MODEL'  # pretrained MLM path
...
for e in range(100):
    ...
    if aps >best_pre:
        ...
        best_pre = aps
    print("epoch: {} \t| aps: {}\t| auroc: {}".format(e, aps, roc))
